...
func (hb *Heartbeat) HeartbeatReq(tbox *Tbox, reqMsg *message.Message) error {
	...
	tbox.PushEventChannel(EventHeartbeatAck, reqMsg)

	return nil
}

func (hb *Heartbeat) HeartbeatAck(tbox *Tbox, reqMsg *message.Message) error {
